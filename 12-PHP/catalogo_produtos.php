	...
	<body>
		...
		<div class="container">
			<div class="row">
  			...
  			<div class="row">
    			<div class="col-md-4">
    				<form role="form" action="detalhes_produtos.php" method="post">  <!--method get and post as informações trafegadas atraves do formulario não ficam expostas na URL-->
					  <div class="form-group">
					    ...
					    <select class="form-control" name="id_produto" id="id_produto">
							...
							<option value="5">"Frase motivacional"</option>
					   	</select>
					  </div>
